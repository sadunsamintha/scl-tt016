...
public class PlcShortVariableRenderer extends JPanel implements IPlcVariableDescriptorListener {
	...
	protected PlcShortVariableDescriptor plcVar;

	public PlcShortVariableRenderer(final PlcShortVariableDescriptor plcVar) {
		this.plcVar = plcVar;
	...
	public PlcShortVariableDescriptor getPlcVar() {
		return plcVar;
	}
