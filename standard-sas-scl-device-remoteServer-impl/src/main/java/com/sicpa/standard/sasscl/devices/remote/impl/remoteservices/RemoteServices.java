...
public class RemoteServices implements IRemoteServices {
	...
	private ActivationServiceHandler activationService;
	...
	private ActivationServiceHandler createActivationBean() throws NamingException {
		return (ActivationServiceHandler) getService(SERVICE_ACTIVATION_BUSINESS_SERVICE);
	}
