...
public class TT079ExtendedCodeFactoryTest {


    @Test
    public void createExCodes() {
        TT079ExtendedCodeFactory extendedCodeFactory = createExtendedCodeFactory();
    ...
    private TT079ExtendedCodeFactory createExtendedCodeFactory() {
    	TT079ExtendedCodeFactory extendedCodeFactory = new TT079ExtendedCodeFactory();
