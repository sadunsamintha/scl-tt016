...
public class TT079SicpaDataGeneratorWrapperTest {
    ...
    public void getEncryptedCodes() throws CryptographyException, SicpadataException {
        ...
        // test
        TT079SicpaDataGeneratorWrapper sicpaDataGeneratorWrapper = new TT079SicpaDataGeneratorWrapper(generator, year, subsystemId,  cryptoFieldsConfig);
        List<String> codes = sicpaDataGeneratorWrapper.getEncryptedCodes(1000L);

        // assert & verify
        Assert.assertEquals("0996908468" + TT079SicpaDataGeneratorWrapper.BLOCK_SEPARATOR + "093G001YG", codes.get(0));
    ...
    private List<SCLCodesFactory.SCLCode> createSclCodes() {
        ...
        sclCode.addCodeForTptinting(SCLCodesFactory.SCLCode.HRD_KEY,"093G001YG");
