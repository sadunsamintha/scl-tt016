...
public enum EjectorPlcEnums {
	...
	PARAM_LINE_INHIBIT_EJECT_TABLE_PARTIAL(".com.stLine[#x].stParameters.bInhibitEjectTablePartial", PlcUtils.PLC_TYPE.B),
	PARAM_LINE_INHIBIT_EJECT_TABLE_FULL(".com.stLine[#x].stParameters.bInhibitEjectTableFull", PlcUtils.PLC_TYPE.B);
