...
public class EncoderDTO implements IEncoderDTO {
	...
	public EncoderDTO(IMoroccoEncoder encoder) {
		...
		setEncoderSubsystemId(GlobalConfig.getInstance().getSubsystemId());
		mCurrentIndex = 0;
	}
	...
	public boolean isValid() {
		return (mSubSystemId == GlobalConfig.getInstance().getSubsystemId());
	}
	 ...
	 * @throws Exception
	 * @see com.sicpa.tt016.spl.business.model.encryption.IEncoderDTO#getEncryptedCode()
	 */
	...
	public String toString() {
		return "EncoderDTO [mRemainingCodes=" + mRemainingCodes + ", mCurrentIndex=" + mCurrentIndex
				+ ", mSubSystemId=" + mSubSystemId + ", batchId=" + mEncoder.getBatchId() + ", capacity="
				+ mEncoder.getCapacity() + "]";
	}
	 ...
	 * @see com.sicpa.tt016.spl.business.model.encryption.IEncoderDTO#isEncoderEmpty()
	 */
	...
	public void load(String password) {
		try {
			...
			LOGGER.fatal(ExceptionToString.toString(e));
		}
	}
