...
import com.sicpa.tt084.client.common.security.TT084SecurityModelWrapper;
...
public class TT084TestSpringContextConfig {
  ...
  @Bean
  public TT084SecurityModelWrapper securityModelWrapperBean(){
    return new TT084SecurityModelWrapper<>(securityModel);
  }
  ...
  static PropertySourcesPlaceholderConfigurer buildTestPropertiesByProfile(final String mode){
    ...
    properties.setProperty("profile.path", "profiles/TT084-"+ mode);
