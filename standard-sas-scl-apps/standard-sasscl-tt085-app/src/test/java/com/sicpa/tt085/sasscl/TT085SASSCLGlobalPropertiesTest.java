package com.sicpa.tt085.sasscl;
...
public class TT085SASSCLGlobalPropertiesTest {
    ...
    public TT085SASSCLGlobalPropertiesTest(final String custoId, final String dmEncoding, final String dmFormat,
    ...
    public static Iterable<Object[]> data() throws Throwable{
        return Arrays.asList(new Object[][]{
                {"TT085", "ASCII", "DM_8x18", "tur", "productionConfig-SCL", "profiles/TT085-SCL/config", not(nullValue()), not(nullValue())},
                {"TT085", "ASCII", "DM_8x18", "tur", "productionConfig-SAS", "profiles/TT085-SAS/config", nullValue(), nullValue()}
        });
    }
    ...
    @Test
    public void defaultLanguage_ShouldBe_Turkish(){
        //Given
