package com.sicpa.tt085.controller.productionconfig;
...
@ActiveProfiles("SAS")
@ContextConfiguration(classes = TT085TestSpringContextConfig.class)
public class TT085ProductionConfigSASTest {
  ...
  @Test
  public void productionConfig_ShouldNotHave_CountingMode(){
    //Given
