...
public class TT080PostPackageTest {

    @Mock private ProductionConfigProvider productionConfigProvider;

    @Mock private IProductionConfig config;

    @InjectMocks private TT080PostPackage postPackage = new TT080PostPackage();
    ...
    public void provideCode() {
        ...
        //prepare the test
        TT080PrinterAdaptorSimulator requestor = new TT080PrinterAdaptorSimulator();
