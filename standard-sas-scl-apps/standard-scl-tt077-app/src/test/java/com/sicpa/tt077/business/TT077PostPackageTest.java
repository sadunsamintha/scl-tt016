...
public class TT077PostPackageTest {

    @Mock private ProductionConfigProvider productionConfigProvider;

    @Mock private IProductionConfig config;

    @InjectMocks private TT077PostPackage postPackage = new TT077PostPackage();
    ...
    public void provideCode() {
        ...
        //prepare the test
        TT077PrinterAdaptorSimulator requestor = new TT077PrinterAdaptorSimulator();
