...
public class TT077SicpaDataGeneratorWrapperTest {
    ...
    public void getEncryptedCodes() throws CryptographyException, SicpadataException {
        ...
        // test
        TT077SicpaDataGeneratorWrapper sicpaDataGeneratorWrapper = new TT077SicpaDataGeneratorWrapper(generator, year, subsystemId,  cryptoFieldsConfig);
        List<String> codes = sicpaDataGeneratorWrapper.getEncryptedCodes(1000L);

        // assert & verify
        Assert.assertEquals("0996908468" + TT077SicpaDataGeneratorWrapper.BLOCK_SEPARATOR + "093G001YG", codes.get(0));
