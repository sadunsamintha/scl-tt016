...
public class TT077ExtendedCodeFactoryTest {


    @Test
    public void createExCodes() {
        TT077ExtendedCodeFactory extendedCodeFactory = createExtendedCodeFactory();
    ...
    private TT077ExtendedCodeFactory createExtendedCodeFactory() {
        TT077ExtendedCodeFactory extendedCodeFactory = new TT077ExtendedCodeFactory();
