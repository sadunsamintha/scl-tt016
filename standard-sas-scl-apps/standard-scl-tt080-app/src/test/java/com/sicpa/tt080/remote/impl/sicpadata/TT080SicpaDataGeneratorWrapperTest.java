...
public class TT080SicpaDataGeneratorWrapperTest {
    ...
    public void getEncryptedCodes() throws CryptographyException, SicpadataException {
        ...
        // test
        TT080SicpaDataGeneratorWrapper sicpaDataGeneratorWrapper = new TT080SicpaDataGeneratorWrapper(generator, year, subsystemId,  cryptoFieldsConfig);
        List<String> codes = sicpaDataGeneratorWrapper.getEncryptedCodes(1000L);

        // assert & verify
        Assert.assertEquals("0996908468" + TT080SicpaDataGeneratorWrapper.BLOCK_SEPARATOR + "093G001YG", codes.get(0));
