...
public class RemoteServerSimulator extends AbstractRemoteServer implements ISimulatorGetEncoder, IBisCredentialProvider {
  ...
  protected IBSicpadataGenerator generateEncoders(long batchId, long codeType) throws UnknownModeException,
  ...
  /**
   * Generates encoders based on the batches quantity. This method uses the standard crypto business to generate a list of the business
   * encoder - <code>IBEncoder</code>. This list of <code>IBEncoder</code> is wrapped in the StdCryptoEncoderWrapper to be returned
   */
  @Override
