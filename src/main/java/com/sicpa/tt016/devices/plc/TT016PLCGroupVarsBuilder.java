 ...
 */
public class TT016PLCGroupVarsBuilder {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(TT016PLCGroupVarsBuilder.class);
   ...
   */
  @Subscribe
  public void handleReloadEditableVariables(final TT016ReloadPLCGroupVarsEvent evt){
