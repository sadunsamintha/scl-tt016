...
public class TT016ProductionStatisticsAggregator extends ProductionStatisticsAggregator {
	...
	protected void setReportData(ReportData reportData, IncrementalStatistics incrStats) {
		...
		((TT016ReportData) reportData).setNett(((TT016IncrementalStatistics) incrStats).getNettCount());
		((TT016ReportData) reportData).setGross(((TT016IncrementalStatistics) incrStats).getGrossCount());
	}
}
