...
public class TT016SelectProductionParametersViewControllerSCL extends SelectProductionParametersViewController {
    ...
    public void setPlcPersistentGrossNetProductCounterManager(
			PlcPersistentGrossNetProductCounterManagerSCL plcPersistentGrossNetProductCounterManager) {
