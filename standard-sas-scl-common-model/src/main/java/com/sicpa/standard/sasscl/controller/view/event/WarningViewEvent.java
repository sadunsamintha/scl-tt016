...
public class WarningViewEvent {
	...
	public WarningViewEvent(final String messageLangKey, final boolean update, Object... params) {
		this.messageLangKey = messageLangKey;
		this.update = update;
		this.params = params;
	}

	public WarningViewEvent(final String messageLangKey, String codeExt, final boolean update, Object... params) {
		this.messageLangKey = messageLangKey;
		this.update = update;
		this.params = params;
