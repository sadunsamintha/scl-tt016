...
public interface MessageEventKey {
	...
	public static interface PLC {
		...
		String PLC_WAR_UPS_LOW_BATTERY_ALARM = "PLC.WARNING.UPS_LOW_BATTERY_ALARM";
		...
		String PLC_WAR_UPS_BATTERY_MODE = "PLC.WARNING.UPS_BATTERY_MODE";
		String PLC_WAR_ENCODER_CHECK_THRESHOLD = "PLC.WARNING.ENCODER_CHECK_THRESHOLD";
		
		/**
		 * SECONDARY WARNINGS Messages (CONVEYOR)
		 */
		String PLC_WAR_CAM_LOC_AFT_EJ = "PLC.WARNING.CAM_LOC_AFT_EJ";
		String PLC_WAR_INCOHERENT_SMALL_REJ_LIMIT = "PLC.WARNING.INCOHERENT_SMALL_REJ_LIMIT";
		String PLC_WAR_INCOHERENT_LARGE_REJ_LIMIT = "PLC.WARNING.INCOHERENT_LARGE_REJ_LIMIT";
		String PLC_WAR_SECOND_LABEL_APP_OR_AIR_DRYER_WARNING = "PLC.WARNING.SECOND_LABEL_APP_OR_AIR_DRYER_WARNING";
		String PLC_WAR_INVALIDTYP_FOR_PRDCTRL_EJ = "PLC.WARNING.INVALIDTYP_FOR_PRDCTRL_EJ";
		String PLC_WAR_INCOHERENT_LIFE_CHCK_TIMEOUT = "PLC.WARNING.INCOHERENT_LIFE_CHCK_TIMEOUT";
		String PLC_WAR_PC_DISTANCE_LOC_AFTER_PC_EJ = "PLC.WARNING.PC_DISTANCE_LOC_AFTER_PC_EJ";
		String PLC_WAR_INCOHERENT_JAVA_NOTIFICATION_DISTANCE = "PLC.WARNING.INCOHERENT_JAVA_NOTIFICATION_DISTANCE";
		String PLC_WAR_UPS_BATTERY_CHARGING = "PLC.WARNING.UPS_BATTERY_CHARGING";
		...
		String PLC_ERR_WIPER_LOC_AFTER_CAMERA = "PLC.ERROR.WIPER.LOC.AFTER.CAM";
		String PLC_ERR_ENCODER_CHECK_THRESHOLD = "PLC.ERROR.ENCODER_CHECK_THRESHOLD";
		
		/**
		 * SECONDARY ERRORS Messages (CONVEYOR)
		 */
		String PLC_ERR_PRINTER_LOC_AFTER_CAM = "PLC.ERROR.PRINTER_LOC_AFTER_CAM";
		String PLC_ERR_INVALID_PROD_CTRL_EJ_DISTANCE = "PLC.ERROR.INVALID_PROD_CTRL_EJ_DISTANCE";
		String PLC_ERR_AUDIO_VISUAL_LOC_BEFORE_EJ = "PLC.ERROR.AUDIO_VISUAL_LOC_BEFORE_EJ";
		String PLC_ERR_SECOND_LABEL_APP_NOT_READY = "PLC.ERROR.SECOND_LABEL_APP_NOT_READY";
		String PLC_ERR_SECOND_LABEL_APP_FAULT = "PLC.ERROR.SECOND_LABEL_APP_FAULT";
		String PLC_ERR_DOUBLE_LABEL_APP_ERROR = "PLC.ERROR.DOUBLE_LABEL_APP_ERROR";
		String PLC_ERR_TWO_MODES_SET_AT_SAMETIME = "PLC.ERROR.TWO_MODES_SET_AT_SAMETIME";
