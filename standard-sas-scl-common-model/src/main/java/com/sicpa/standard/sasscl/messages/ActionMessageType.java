...
public class ActionMessageType extends MessageType {
	...
	public static final ActionMessageType IGNORE = new ActionMessageType("IGNORE", ActionEventIgnore.class);
	...
	public static final ActionMessageType LOG = new ActionMessageType("LOG", ActionEventLog.class);
