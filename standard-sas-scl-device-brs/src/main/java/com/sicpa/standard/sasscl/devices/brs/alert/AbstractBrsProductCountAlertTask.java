...
public abstract class AbstractBrsProductCountAlertTask extends AbstractAlertTask {
	...
	private final ResettableAtomicCounter brsProductsDeltaCounter = new ResettableAtomicCounter();

	private boolean isUnreadBarcodesEnable;
	private int unreadBarcodesThreshold;
	...
	public void setUnreadBarcodesThreshold(int unreadBarcodesThreshold) {
		this.unreadBarcodesThreshold = unreadBarcodesThreshold;
	}

	public int getUnreadBarcodesThreshold() {
		return unreadBarcodesThreshold;
	}
}
