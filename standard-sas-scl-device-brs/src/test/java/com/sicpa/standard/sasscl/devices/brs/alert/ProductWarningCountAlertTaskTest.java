...
public class ProductWarningCountAlertTaskTest extends  ProductCountAlertTaskAbstractTest{
    ...
    public void setUnreadBarcodesThreshold(int threshold) {
        //safe cast
        ((ProductWarningCountAlertTask)task).setUnreadBarcodesWarningThreshold(threshold);

    }

    @Test
    public void getAlertMessage() {
        Assert.assertEquals(MessageEventKey.BRS.BRS_TOO_MANY_UNREAD_BARCODES_WARNING, ((ProductWarningCountAlertTask)task).getAlertMessage().getKey());
    }
