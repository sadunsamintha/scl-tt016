...
beans {
	...
	plcMap['PARAM_LINE_MAINTENANCE_MODE_ENABLED']=[v:LINE_PRM+'bMaintenanceModeEnabled' ,t:S]
	...
	plcMap['NTF_LINE_JAVA_PROD_FIFO_WRITE_IDX']=[v:LINE_NTF+'nJavaProdFifoWriteIndex' ,t:I ]
	...
	plcMap['PARAM_CAB_WAR_TEMP_EE_CAB_LVL']=[v:CAB_PRM+'nWar_Temperature_EE_cabinet_level' ,t:I ,cabGrp:'temp']
	plcMap['PARAM_CAB_WAR_TEMP_AMBIANT_LVL']=[v:CAB_PRM+'nWar_Temperature_ambiant_level' ,t:I ,cabGrp:'temp']
	plcMap['PARAM_CAB_WAR_TEMP_BYPASS_LVL']=[v:CAB_PRM+'nWar_Temperature_bypass_level' ,t:I ,cabGrp:'temp']
	plcMap['PARAM_CAB_ERR_TEMP_EE_CAB_LVL']=[v:CAB_PRM+'nErr_Temperature_EE_cabinet_level' ,t:I ,cabGrp:'temp']
	plcMap['PARAM_CAB_ERR_TEMP_AMBIANT_LVL']=[v:CAB_PRM+'nErr_Temperature_ambiant_level' ,t:I ,cabGrp:'temp']
	plcMap['PARAM_CAB_ERR_TEMP_BYPASS_LVL']=[v:CAB_PRM+'nErr_Temperature_bypass_level' ,t:I ,cabGrp:'temp']
	plcMap['PARAM_CAB_WAR_AIR_PRESS_LVL']=[v:CAB_PRM+'nWar_air_pressure_level' ,t:I ,cabGrp:'air']
	plcMap['PARAM_CAB_ERR_AIR_PRESS_LVL']=[v:CAB_PRM+'nErr_air_pressure_level' ,t:I ,cabGrp:'air']
	plcMap['PARAM_CAB_WAR_FANS_EE_CAB_MIN_FREQ']=[v:CAB_PRM+'nWar_Fans_EE_cabinet_MIN_freq' ,t:I ,cabGrp:'fan']
	plcMap['PARAM_CAB_WAR_FANS_EE_CAB_MAX_FREQ']=[v:CAB_PRM+'nWar_Fans_EE_cabinet_MAX_freq' ,t:I ,cabGrp:'fan']
	plcMap['PARAM_CAB_WAR_FANS_BYPASS_CAB_MIN_FREQ']=[v:CAB_PRM+'nWar_Fans_Bypass_cabinet_MIN_freq' ,t:I ,cabGrp:'fan']
	plcMap['PARAM_CAB_WAR_FANS_BYPASS_CAB_MAX_FREQ']=[v:CAB_PRM+'nWar_Fans_Bypass_cabinet_MAX_freq' ,t:I ,cabGrp:'fan']
	plcMap['PARAM_CAB_FANS_TEMP_ON_THRESHOLD_EE']=[v:CAB_PRM+'nFans_Temp_ON_threshold_EE' ,t:I ,cabGrp:'fan']
	plcMap['PARAM_CAB_FANS_TEMP_OFF_DELTA_HYST_EE']=[v:CAB_PRM+'nFans_Temp_OFF_delta_hyst_EE' ,t:I ,cabGrp:'fan']
	plcMap['PARAM_CAB_FANS_TEMP_ON_THRESHOLD_BYPASS']=[v:CAB_PRM+'nFans_Temp_ON_threshold_Bypass' ,t:I ,cabGrp:'fan']
	plcMap['PARAM_CAB_FANS_TEMP_OFF_DELTA_HYST_BYPASS']=[v:CAB_PRM+'nFans_Temp_OFF_delta_hyst_Bypass' ,t:I ,cabGrp:'fan']
