...
beans {
	...
	plcMap['NTF_CAB_CX_BOARD_TEMPERATURE']=[v:CAB_NTF+'nCX_Board_temperature' ,t:BY ,cabNtf:'true']
	plcMap['NTF_CAB_CX_CPU_TEMPERATURE']=[v:CAB_NTF+'nCX_CPU_temperature' ,t:BY ,cabNtf:'true']
	plcMap['NTF_CAB_TEMPERATURE_EE_CAB']=[v:CAB_NTF+'nTemperature_EE_cabinet' ,t:S ,cabNtf:'true']
	plcMap['NTF_CAB_TEMPERATURE_AMBIANT']=[v:CAB_NTF+'nTemperature_ambiant' ,t:S ,cabNtf:'true']
