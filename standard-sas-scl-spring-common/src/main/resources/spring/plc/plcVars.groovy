...
beans {
	...
	plcMap['PARAM_LINE_INHIBIT_LBL_APP_OR_AIR_DRYER']=[v:LINE_PRM+'bInhibitLblAppOrAirDryer' ,t:B, lineGrp:'lblapp']
	...
	plcMap['PARAM_LINE_LABEL_APPLICATOR_DISTANCE']=[v:LINE_PRM+'nLabelApplicatorDistance' ,t:D, lineGrp:'lblapp']
	plcMap['PARAM_LINE_LABEL_APPLICATOR_DISTANCE_TYPE']=[v:LINE_PRM+'bLabelApplicatorDistanceType' ,t:B]
	plcMap['PARAM_LINE_LABEL_APPLICATOR_LENGTH']=[v:LINE_PRM+'nLabelApplicatorLength' ,t:D, lineGrp:'lblapp']
	plcMap['PARAM_LINE_LABEL_APPLICATOR_LENGTH_TYPE']=[v:LINE_PRM+'bLabelApplicatorLengthType' ,t:B]
	plcMap['PARAM_LINE_LABEL_APPLICATOR_2_DISTANCE']=[v:LINE_PRM+'n2ndLabelApplicatorDistance' ,t:D, lineGrp:'lblapp']
	...
	plcMap['PARAM_LINE_ENCODER_CHECK_WARNING_THRESHOLD']=[v:LINE_PRM+'nEncoderCheckWarningThreshold' ,t:S ,lineGrp:'encoder']
	plcMap['PARAM_LINE_ENCODER_CHECK_ERROR_THRESHOLD']=[v:LINE_PRM+'nEncoderCheckErrorThreshold' ,t:S ,lineGrp:'encoder']
	...
	plcMap['NTF_CAB_CX_BOARD_TEMPERATURE']=[v:CAB_NTF+'nCX_Board_temperature' ,t:BY ,cabNtf:'false']
	plcMap['NTF_CAB_CX_CPU_TEMPERATURE']=[v:CAB_NTF+'nCX_CPU_temperature' ,t:BY ,cabNtf:'false']
	plcMap['NTF_CAB_TEMPERATURE_EE_CAB']=[v:CAB_NTF+'nTemperature_EE_cabinet' ,t:S ,cabNtf:'false']
	plcMap['NTF_CAB_TEMPERATURE_AMBIANT']=[v:CAB_NTF+'nTemperature_ambiant' ,t:S ,cabNtf:'false']
