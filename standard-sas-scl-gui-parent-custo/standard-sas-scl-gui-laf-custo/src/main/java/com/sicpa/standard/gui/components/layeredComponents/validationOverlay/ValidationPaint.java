...
public abstract class ValidationPaint {
	 ...
	 *            height of the layer
	 * @param animProgress
	 *            goes from 0 to 1 and then from 1 to 0, the duration of the
	 *            animation can be set using
	 *            ValidationOverlay.setAnimationDuration
	 */
	public abstract void paint(Graphics2D g, List<String> msg, JXLayer<? extends JComponent> layer, float animProgress);
