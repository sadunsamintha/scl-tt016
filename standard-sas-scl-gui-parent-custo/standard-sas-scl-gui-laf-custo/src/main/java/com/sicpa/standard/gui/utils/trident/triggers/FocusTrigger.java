package com.sicpa.standard.gui.utils.trident.triggers;
 ...
 * events. For example, to have anim start when component receives an GAINED
...
public class FocusTrigger extends Trigger implements FocusListener {
	 ...
	 */
	public static FocusTrigger addTrigger(final JComponent component, final Timeline timeline,
			final FocusTriggerEvent event) {
	 ...
	 */
	public static FocusTrigger addTrigger(final JComponent component, final Timeline timeline,
			final FocusTriggerEvent event, final boolean autoReverse) {
