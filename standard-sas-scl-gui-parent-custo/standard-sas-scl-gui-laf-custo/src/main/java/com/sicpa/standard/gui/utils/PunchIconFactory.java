...
public class PunchIconFactory {
    public static Icon createPunchedIcon(final Image image,
        ...
        // shadow.
        BufferedImage newImage =GraphicsUtilities.createCompatibleTranslucentImage(image.getWidth(null),
    ...
    private static BufferedImage createInnerShadow(
            final Image image, final int unblurredShadowSize_pixels) {
        ...
        BufferedImage punchedImage =GraphicsUtilities.createCompatibleTranslucentImage(image.getWidth(null) + twiceShadowSize,
