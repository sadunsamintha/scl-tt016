...
public abstract class ButtonCellEditor extends SubstanceDefaultTableCellRenderer implements CellEditor,
	...
	public ButtonCellEditor() {
		...
		if (SubstanceLookAndFeel.isCurrentLookAndFeel()) {
			Color fg = SubstanceColorSchemeUtilities.getColorScheme(this.renderer, ComponentState.SELECTED)
					.getForegroundColor();
	...
	public Component getTableCellEditorComponent(final JTable table, final Object value, final boolean isSelected,
		...
		prepareRenderer(this.panelEditor, table, row, isSelected);
	...
	public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected,
		...
		prepareRenderer(this.panelRenderer, table, row, isSelected);
