...
public class ValidationOverlayFactory {
	...
	private static <T extends JComponent> ValidationOverlay createErrorOverlayedIcon(
			final List<Validator<T>> validators, final T originalTrackedComp, final Color color,
			final boolean animatedPaint, final boolean withIcon) {
