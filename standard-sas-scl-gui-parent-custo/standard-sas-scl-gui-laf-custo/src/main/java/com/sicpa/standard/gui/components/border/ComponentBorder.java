...
public class ComponentBorder implements Border {
	 ...
	 */
	public ComponentBorder(final JComponent component) {
	 ...
	 */
	public ComponentBorder(final JComponent component, final Edge edge) {
	 ...
	 */
	public ComponentBorder(final JComponent component, final Edge edge, final float alignment) {
	...
	public void setAdjustInsets(final boolean adjustInsets) {
	...
	public void paintBorder(final Component c, final Graphics g, final int x, final int y, final int width,
			final int height) {
		float x2 = (width - this.component.getWidth()) * this.component.getAlignmentX() + x;
