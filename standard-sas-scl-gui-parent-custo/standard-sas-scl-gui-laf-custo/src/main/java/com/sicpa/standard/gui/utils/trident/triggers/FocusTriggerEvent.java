 ...
 * 
 * @author Chet
 * @author Rémy Rakic - Modifications for Trident + renaming the IN/OUT events
 *         to the more familiar GAINED/LOST
 */
public class FocusTriggerEvent extends TriggerEvent {
	...
	/**
	 * This method finds the opposite of the current event.: GAINED -> LOST and
	 * LOST -> GAINED.
	 */
	@Override
