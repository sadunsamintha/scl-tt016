...
public class TaskButton extends JButton {
	...
	private Color categoryColor = SicpaColor.BLUE_MEDIUM;
	...
	public TaskButton(final String name, final String description, final BufferedImage image, final boolean textVCenter) {
		...
		SicpaLookAndFeelCusto.turnOffGhostingEffectOnButton(this);
	...
	public static void main(final String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				TaskButton b = new TaskButton("Refresh", "Fetch up to date informations", img);
