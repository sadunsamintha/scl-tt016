 ...
 * @(#)PathWriter.java
 *
 * $Date: 2010-03-19 18:56:26 -0500 (Fri, 19 Mar 2010) $
 *
...
public abstract class PathWriter {
	...
	/** Adds a curved segment, defined by three new points, to the path by drawing a BŽzier curve that intersects both the current coordinates and the coordinates (x3, y3), using the specified points (x1, y1) and (x2, y2) as BŽzier control points. */
