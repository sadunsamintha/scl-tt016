...
//    SICPA_BLUE(SicpaColor.BLUE_LIGHT, SicpaColor.BLUE_ULTRA_LIGHT, SicpaColor.BLUE_LIGHT, Color.BLACK, new Color(0, 0, 90)),
    SICPA_BLUE(SicpaColor.BLUE_LIGHT, SicpaColor.CLOUD_GREY, SicpaColor.BLUE_LIGHT, Color.BLACK, new Color(0, 0, 90)),
