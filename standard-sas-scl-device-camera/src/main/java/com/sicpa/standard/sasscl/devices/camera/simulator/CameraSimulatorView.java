...
public class CameraSimulatorView extends AbstractSimulatorView {

	protected CameraSimulatorController controller;
	...
	public CameraSimulatorView(CameraSimulatorController controller) {
	...
	protected void buttonConnectActionPerformed() {
		controller.fireStatusChanged(CameraDriverEventCode.CONNECTED);
	}

	protected void buttonDisconnectActionPerformed() {
		controller.stopReading();
		controller.fireStatusChanged(CameraDriverEventCode.DISCONNECTED);
	}
